...
//    prot("Protocol"),                        //6 no need, all are HTTP packets
    ...
    fw_content_length_avg("Forward Content Length Avg"),
    fw_content_length_std("Forward Content Length Std"),
    fw_content_length_max("Forward Content Length Max"),
    fw_content_length_min("Forward Content Length Min"),
    fw_content_length_total("Forward Content Length Total"),
    bw_content_length_avg("Backward Content Length Avg"),
    bw_content_length_std("Backward Content Length Std"),
    bw_content_length_max("Backward Content Length Max"),
    bw_content_length_min("Backward Content Length Min"),
    bw_content_length_total("Backward Content Length Total"),
